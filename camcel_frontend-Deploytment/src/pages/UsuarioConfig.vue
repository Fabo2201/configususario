  ...
  <q-page padding class="q-pa-md flex flex-center">
    <q-card class="q-pa-md" style="width: 100%; max-width: 1000px; min-height: 600px;">
      ...
      <q-card-section class="text-center">
        ...
        <q-btn flat color="primary" label="Cambiar foto de perfil" icon="camera_alt" @click="changePhoto" />
      </q-card-section>
...
function changePhoto() {
  $q.notify({
    color: "info",
    message: "Funcionalidad para cambiar la foto de perfil aún no implementada.",
    icon: "info",
  });
}
